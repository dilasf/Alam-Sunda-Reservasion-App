...
<body>
        ...
        <nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center">
            ...
            @guest
                <div class="flex items-center space-x-4">
                    ...
                    <a href="/register"
                        class="px-4 py-2 text-sm font-medium text-white transition-colors duration-200 bg-gradient-to-r from-green-400 to-blue-500 rounded-md hover:from-green-500 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-400">
                        Sign up
                    </a>
                </div>
            @endguest
                ...
                <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                    <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                        <span class="hidden text-right lg:block">
                            ...
                            <span class="block text-xs font-medium">{{ Auth::user()->role_text }}</span>
                        </span>
                    ...
                    <div x-show="dropdownOpen"
                        class="absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark z-50">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const inputFile = document.getElementById('fotoBukti');
            const previewContainer = document.getElementById('imagePreview');
            const previewImage = previewContainer.querySelector('img');
            const uploadForm = document.getElementById('uploadForm');
            const submitButton = document.getElementById('submitButton');
            const submitText = submitButton.querySelector('span:not(#loadingText)');
            const loadingText = document.getElementById('loadingText');

            // Preview image ketika file dipilih
            ...
            uploadForm.addEventListener('submit', function(e) {
                ...
                // Form akan di-submit secara normal karena kita menggunakan POST biasa
            });
        });
    </script>
</body>
